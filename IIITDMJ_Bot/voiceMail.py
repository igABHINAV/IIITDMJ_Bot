...
if uinp==3:
    ...
    # l=details(n) : n waali location agar database me hogi toh ye fetch krk location de dega
    #               ab iska kaise use karna hai ye dekh lena
    # l[0]= naam
    # l[1]= longitude
    # l[2]=latitude
    # l[3] = about
